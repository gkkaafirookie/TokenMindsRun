...
public class PlayerHandler : Singleton<PlayerHandler>
{
    ...
    public void Initialize()
    {
        ...
        //AudioConductor.PlaySound2DLooped(stillClip, 0.3f);
        ResetSpeed();
    }
    ...
    {
        return m_PlayerSpeed switch
        {
            PlayerSpeedPreset.Slow => 5.0f,
            PlayerSpeedPreset.Medium => 10.0f,
            PlayerSpeedPreset.Fast => 20.0f,
            _ => m_CustomPlayerSpeed,
        };
    }
    ...
    {
        return transform.position + Vector3.up * (m_StartHeight * m_Scale.y - m_StartHeight);
    }
    ...
    void Update()
    {
        ...
        if (!DataManager.GameData.isGamePlaying)
            return;
        // Update Scale
